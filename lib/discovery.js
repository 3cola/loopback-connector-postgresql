    ...
    var callback = function(err, results) {
      if (err) {
        ...
        results.map(function(r) {
          // TODO: rewrite the hack bellow
          // HACK: redshift expose only lowercase column alias name in results
          if (!r.dataType && r.datatype) {
            r.tableName = r.tablename;
            r.columnName = r.columnname;
            r.dataType = r.datatype;
            r.dataLength = r.datalength;
            r.dataPrecision = r.dataprecision;
            r.dataScale = r.datascale;
            delete r.tablename;
            delete r.columnname;
            delete r.datatype
            delete r.datalength;
            delete r.dataprecision;
            delete r.datascale;
          }
